        ...
        <div class="row">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                                <li>Gérer le patrimoine informatique</li>
                                <li>Mettre à disposition des utilisateurs un service informatique</li>
                                <li>Organiser son développpement professionnel</li>
                            </ul>
                        </td>
                        <td>
                            <ul style='font-size: 10px;'>
                    ...
                    <tr>
                        <td><a href='canin.php' class="btn btn-primary btn-custom">Projet n°1</a></td>
                        <td>Création d'un logiciel de gestion de magasin</td>
                        <td>
                            <ul>
                                <li>Gérer le patrimoine informatique</li>
                    ...
                    <tr>
                        <td><a href='electron.php' class="btn btn-primary btn-custom">Projet n°2</a></td>
                        <td>Création d'un similateur immobilier avec electron</td>
                        <td>
                            <ul>
                                <li>Gérer le patrimoine informatique</li>
                                <li>Mettre à disposition des utilisateurs un service informatique</li>
